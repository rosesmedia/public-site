...
const GO_LINKS: Record<string, string> = {
    'stream-keys': 'https://docs.google.com/spreadsheets/d/12LvxeXGz3GcIUrza5TVJ6PbAsd7t6gQXDRj_jFvKFgk/edit?gid=0#gid=0',
...
export default async function GoRedirect(
    { params }: { params: Promise<{ go: string }> }
) {
    ...
    if (Object.prototype.hasOwnProperty.call(GO_LINKS, go)) {
        ...
        return <>
            ...
            <p>
                If you have not been redirected, please click to go to <a style={{ textDecoration: 'underline', color: 'blue' }} href={target}>{target}</a>.
            </p>
        </>
    } else {
        notFound();
